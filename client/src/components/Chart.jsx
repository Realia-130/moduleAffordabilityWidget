  ...
  return (
    <ChartContainer>
      ...
      <svg width="100%" height="100%" viewBox="0 0 36 36">
        ...
        <circle cx="18" cy="18" r="15.91549430918952" fill="none" stroke="rgb(194, 213, 0)" strokeWidth="3.8" strokeDasharray={`${homeInsuranceFill} ${100 - homeInsuranceFill}`} strokeDashoffset={homeOffset} />
        <circle cx="18" cy="18" r="15.91549430918952" fill="none" stroke="rgb(206, 182, 255)" strokeWidth="3.8" strokeDasharray={`${mortgageInsFill} ${100 - mortgageInsFill}`} strokeDashoffset={mortOffset} />
